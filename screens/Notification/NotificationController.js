...
export const sendNotification = async (text, fcmToken, title, from) => {
  ...
  try {
    ...
    myHeaders.append(
      'Authorization',
      'key=AAAAkFan3TM:APA91bGBiinUkSbjW1BJVtTOW6BxMAgEgsRwEgmIC1oaZGqdTO6C_Ft8k1EdsdVSzKYPGwWssLpByGYAOF-k7_MA-NOQAXukrhN-Np32P_WIwF-pgaITodKbnBK9g_UafqXWlSlZehuD',
    );
